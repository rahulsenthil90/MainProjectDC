...
<head>
    ...
    <body style="background-image:url(img/bg3.jpg);background-size:cover;background-position:center center;">
        <nav>
            ...
            <main>
                <form autocomplete="off" id="form" action="findpackers.php" method="POST" class="form">
                        <section class="main">
                        <i><h2><span class="s4">D</span>eliver    <span class="s4">C</span>hoice</h2></i>
                        <h1 class="heading">Packers & Movers</h1>
                        <form action="#">
                        <div class="main-box">
                        ...
                        <div class="btn">
                            <input type="submit" name="findpacker" value="Find Packers & Movers">
                        </div>
                        </form>
                    </section>
                </form>
