...
if(isset($_POST['reg'])){
    ...
    $insert = "INSERT INTO shipperpost VALUES ('','$sname', '$sph','$fstate', '$fdistrict', '$tstate', '$tdistrict', '$shiptype', '$date','$trucktype', '$trucksize', 'AVAILABLE','','')";
    ...
    { 
        ...
        echo"
                ...
                alert('SUCCESSFULLY POST YOUR SHIPMENT');
...
<head>
    ...
    <body style="background-image:url(img/bg3.jpg);background-size:cover;background-position:center center;">
        <nav>
            ...
            <main>
                <form autocomplete="off" id="form" action="" method="POST" class="form">
                        ...
                        <h1 class="heading">Post Shipment Details</h1>
                        <form action="#">
                        <div class="main-box">
                            <div class="input-box">
                                <input type="text" hidden name="sname" value="<?php echo $fet1['fname']; ?>">
                                <input type="text" hidden name="sphn" value="<?php echo $fet1['phonenumber']; ?>">
                            ...
                            <div class="input-box">
                                ...
                                <input type="date" name="date" placeholder="Please enter the date" required>
                            </div>
                        <div class="input-box">
                        ...
                        <div class="btn">
                            <input type="submit" name="reg" value="Post Shipment Details">
                        </div>
                        </form>
                    </section>
                </form>
