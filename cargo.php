...
<main>
<form autocomplete="off" id="form" action="findcargooffice.php" method="POST" class="form">
<section class="main">
<i><h2><span class="s4">D</span>eliver    <span class="s4">C</span>hoice</h2></i>
<h1 class="heading">Cargo Service</h1>
<form action="#">
<div class="main-box">
...
<div class="btn">
<input type="submit" name="findcompany" value="Find Cargo Service">
</div>
</form>
</section>
</form>
...
"flatbed ":["8ft x 4ft","10ft x 6ft","12ft x 6ft","14ft x 7ft","16ft x 8ft","48ft x 8.5ft","53ft x 8.5ft"],
"open container":["20ft","40ft","45ft"],
"covered truck":["20ft","40ft","40ft high cube","45ft"]
}
