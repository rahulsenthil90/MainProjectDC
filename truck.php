...
<body style="background-image:url(img/bg2.jpg);background-size:cover;background-position:center center;">
    ...
    <main>
    <form autocomplete="off" id="form" action="findtruck.php" method="POST" class="form">
            <section class="main">
                <i><h2><span class="s4">D</span>eliver    <span class="s4">C</span>hoice</h2></i>
                <h1 class="heading">Find a Truck</h1>
                    <form action="#">
                        <div class="main-box">
                            ...
                            <div class="input-box">
                                ...
                                <select id="trucktype" name="ttype" required>
                            ...
                            <div class="input-box">
                                ...
                                <select id="trucksize" name="tsize" required>
                                    <option value=""disabled selected>Select Truck Size</option>
                                </select>
                                </div>
                                </div>
                        <div class="btn">
                            <input type="submit" name="find" value="Find Truck">
                        </div>
                    </form>
            </section>
        </form>
...
"Tamil Nadu": [ "Tiruchirappalli","Ariyalur", "Chennai", "Coimbatore", "Cuddalore", "Dharmapuri", "Dindigul", "Erode", "Kanchipuram", "Kanyakumari", "Karur", "Krishnagiri", "Madurai", "Nagapattinam", "Namakkal", "Nilgiris", "Perambalur", "Pudukkottai", "Ramanathapuram", "Salem", "Sivaganga", "Thanjavur", "Theni", "Thoothukudi (Tuticorin)", "Tirunelveli", "Tiruppur", "Tiruvallur", "Tiruvannamalai", "Tiruvarur", "Vellore", "Viluppuram", "Virudhunagar"],
