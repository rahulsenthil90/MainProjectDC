...
$sel2 = "SELECT * FROM driver WHERE id='$id'";
$qry2 = mysqli_query($conn, $sel2);
$fet2 = mysqli_fetch_assoc($qry2);


if(isset($_POST['booktruck'])){
    $tid = $_POST['tid'];
    $tname = $_POST['tname'];
    $tphone = $_POST['tphone'];
    $sname = $_POST['sname'];
    ...
    $insert = "INSERT INTO truckfound VALUES ('','$tid','$tname','$tphone','$sname','$semail','$sphone','$saddress','$raddress','$date','BOOKED')";
    ...
    <body>
        <nav>
                        ...
                        foreach($qry2 as $fet){
                            ?>
                                ...
                                <div class="input-box1">
                                    <span class="text">Truck Detail</span>
                                    <input type="text" name="name" value="<?php echo $fet['drivername'].", ".$fet['trucktype'].", ".$fet['trucksize'].", ".$fet['district'].", ".$fet['phonenumber'] ?>" required readonly>
                                    <input type="hidden" name="tname" value="<?php echo $fet['drivername'] ?>" />
            ...
            <div class="main-box"> 
                ...
                <div class="input-box">
                    <span class="text">From Address</span>
                ...
                <div class="input-box">
                    ...
                    <div class="btn">
                    <input type="submit" name="booktruck" value="Book Truck">
                    </div>
                    </form>
                    </section>
                </form>
