...
if(isset($_POST['findcompany'])){
    $fstate = $_POST['fstate'];
    $fdis = $_POST['fdistrict'];
    $tstate = $_POST['tstate'];
    $tdis = $_POST['tdistrict'];

    $ser = "SELECT * FROM shipper WHERE state='$fstate' and service='Cargo Service' and district='$fdis' and tostate='$tstate' and todistrict='$tdis'";
                    ...
                    foreach($qr as $row){
                        echo"
                            <tr>
                                ...
                                <td>".$row['caddress']."</td>
                                <td>".$row['landmark']."</td>
                                <td><a style='text-decoration:none; color:black;' href='cargofound.php?id=$row[id]'><ion-icon name='checkbox'></ion-icon></a></td>
                            </tr>";
                            $i++;
                    }
