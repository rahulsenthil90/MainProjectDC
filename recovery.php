...
<head>
    ...
    .main{
    background: rgba(15, 11, 11, 0.970);
    width:1000px;
    height:530px;
    margin-top: 5%;
    padding: 10px 50px;
    ...
    <body style="background-image:url(img/bg5.jpg);background-size:cover;background-position:center center;">
        <nav>
            <?php include('sidenav.php') ?>
        </nav>
            <main>
                <form autocomplete="off" id="form" action="findrecovery.php" method="POST" class="form">
                    <section class="main">
                    <i><h2><span class="s4">D</span>eliver    <span class="s4">C</span>hoice</h2></i>
                    <h1 class="heading">Recovery Vechile Service</h1>
                    <form action="#">
                    <div class="main-box">
...
<div class="input-box">
                            ...
                            <div class="input-box">
                                ...
                                <div class="input-box">
                                <span class="text"disabled selected>To District</span>
                                <select id="districts1" name="tdistrict">
                                    <option value="">Select a District</option>
                                </select>
                            </div>
                            <div class="input-box">
                        <span class="text">Vechile Type</span>
                        <select id="vechile type">
                        <option value=""disabled selected>Select a Vechile Type</option>
                    ...
                    <input type="text" name="problem" placeholder="Describe the problem" required>
                    </div>
                                </div>
                        <div class="btn">
                            <input type="submit" name="findrecovery" value="Find Packers & Movers">
                        </div>
                        </form>
                    </section>
                </form>
