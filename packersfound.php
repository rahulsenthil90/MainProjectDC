...
if(isset($_POST['bookpacker'])){
    ...
    $insert = "INSERT INTO packerfound VALUES ('','$tid','$tname','$tphone','$sname','$semail','$sphone','$saddress','$raddress','$date','BOOKED')";
    $sel = mysqli_query($conn, $insert);
    if($sel){
        echo"
        <script>
            alert('PACKERS & MOVERS BOOKED');
            window.location.href='packers.php'
        </script>
        ";
    }
        ...
        <nav>
                        ...
                        foreach($qry2 as $fet){
                            ?>
                                ...
                                <div class="input-box1">
                                    <span class="text">Packers and Movers Detail</span>
            ...
            <div class="main-box"> 
                ...
                <div class="input-box">
                    ...
                    <div class="btn">
                    <input type="submit" name="bookpacker" value="Book Packers & Movers">
                    </div>
                    </form>
                    </section>
                </form>
