...
if(isset($_POST['bookrecovery'])){
    ...
    $insert = "INSERT INTO recoveryfound VALUES ('','$tid','$tname','$tphone','$sname','$semail','$sphone','$saddress','$raddress','BOOKED')";
    $sel = mysqli_query($conn, $insert);
    if($sel){
        echo"
        <script>
            alert('RECOVERY VECHILE BOOKED');
        ...
        <nav>
            ...
            <div class="main-box"> 
                ...
                <div class="input-box">
                    ...
                    <div class="btn">
                    <input type="submit" name="bookrecovery" value="Book Recovery Vechile">
                    </div>
                    </form>
                    </section>
                </form>
