...
if(isset($_POST['find'])){
    ...
    $ser = "SELECT * FROM driver WHERE state='$state' and district='$dis' and trucktype='$ttype' and trucksize='$tsize'";
    ...
    <table>
            ...
            <tbody>
                ...
                if(mysqli_num_rows($qr) > 0){
                    ...
                    foreach($qr as $row){
                        echo"
                            <tr>
                                ...
                                <td>".$row['district']."</td>
                                <td>".$row['state']."</td>
                                <td><a style='text-decoration:none; color:black;' href='truckfound.php?id=$row[id]'><ion-icon name='checkbox'></ion-icon></a></td>
                            </tr>";
                            $i++;
                    }
                    ...
                    ?>
                    <tr>
                        <td colspan="7">No Truck Available</td>
                    </tr>
