...
$sel = "SELECT * FROM driverreg WHERE urole='Shipper' AND phonenumber='$_SESSION[id]'";
        ...
        <div class="navigation">
            <ul class="sidenav">
                ...
                <li class="list">
                    ...
                    <b></b>
                    <a href="post.php">
                        <span class="icon"><ion-icon name="duplicate-sharp"></ion-icon></span>
                        <span class="title">Post Shipping Detail</span>
                    </a>
                </li>
                <li class="list">
                    <b></b>
                    <b></b>
                    <a href="shippernotify.php">
