...
if(isset($_POST['reg'])){
    $cname = $_POST['cname'];
    $service = $_POST['trucktype'];
    $email = $_POST['email'];
    $phonenumber = $_POST['phonenumber'];
    $state = $_POST['fstate'];
    $district = $_POST['fdistrict'];
    $tostate = $_POST['tstate'];
    $todistrict = $_POST['tdistrict'];
    $caddress = $_POST['caddress'];
    $landmark = $_POST['landmark'];

    $sel ="SELECT * FROM shipper where phonenumber ='$phonenumber' limit 1";
    $insert = "INSERT INTO shipper VALUES ('','$cname', '$service', '$email', '$phonenumber', '$state', '$district', '$tostate', '$todistrict', '$caddress', '$landmark')";
    ...
    { 
        ...
        echo"
                ...
                window.location.href='registercompany.php';
                </script>";
    }
    else 
    {
...
if(isset($_POST['update'])){
    ...
    $update ="UPDATE shipper SET cname='$cname', service='$service', email='$email', phonenumber='$phonenumber', state='$state', district='$district', tostate='$tostate', todistrict='$todistrict', caddress='$caddress', landmark='$landmark' WHERE  phonenumber='$phonenumber'";
...
<body style="background-image:url(img/bg2.jpg);background-size:cover;background-position:center center;">
    ...
    <main>
    <form id="form" autocomplete="off" action="" method="POST" class="form">
            <section class="main">
                <i><h2><span class="s4">D</span>eliver    <span class="s4">C</span>hoice</h2></i>

                            <?php
                            $sel = "SELECT * FROM shipper WHERE phonenumber='$_SESSION[id]'";
                            $qry = mysqli_query($conn, $sel);
                            $fet = mysqli_fetch_assoc($qry);

                            if(mysqli_num_rows($qry)==0){
                                ?>
                                <h1 class="heading">Register Your Details</h1>
                                <form action="" method="post">
                                    <div class="main-box">
                                        <div class="input-box">
                                            <span class="text">Company Name</span>
                                            <input type="text" name="cname" value="<?php echo $fet1['fname']; ?>" readonly required>
                                        </div>
                                        <div class="input-box">
                                            ...
                                            <select id="trucktype" name="trucktype">
                                                ...
                                                <option value="Water Truck Service">Water Truck Service</option>
                                            </select>
                                        </div>
                                        <div class="input-box">
                                            <span class="text">Email</span>
                                            <input type="email" name="email" value="<?php echo $fet1['email']; ?>" readonly required>
                                        </div>
                                        <div class="input-box">
                                            <span class="text">Phone Number</span>
                                            <input type="tel" name="phonenumber" value="<?php echo $fet1['phonenumber']; ?>" readonly required>
                                        </div>
                                        <div class="input-box">
                                            <span class="text">From State</span>
                                            ...
                                            <div class="input-box">
                                            <span class="text">From District</span>
                                            <select id="districts" name="fdistrict">
                                                <option value=""disabled selected>Select a District</option>
                                            </select>
                                        </div>
                                        <div class="input-box">
                                            <span class="text">To State</span>
                                            <select id="states1" name="tstate">
                                                    <option value=""disabled selected>Select a state</option>
                                                    <option value="Tamil Nadu">Tamil Nadu</option>
                                                    <option value="Andhra Pradesh">Andhra Pradesh</option>
                                                    <option value="Arunachal Pradesh">Arunachal Pradesh</option>
                                            ...
                                            <div class="input-box">
                                            <span class="text">To District</span>
                                            <select id="districts1" name="tdistrict">
                                                <option value=""disabled selected>Select a District</option>
                                            </select>
                                        </div>
                                        <div class="input-box">
                                        ...
                                        <div class="input-box">
                                            <span class="text">Nearby Landmark</span>
                                            <input type="text" name="landmark" placeholder="Landmark" required>
                                        </div>
                                    </div>
                                    <div class="btn">
                                        <input type="submit" name="reg" value="Register/Update">
                                    </div>
                                </form>
                                ...
                                <form action="" method="post">
                                    <div class="main-box">
                                        <div class="input-box">
                                            <span class="text">Company Name</span>
                                            <input type="text" name="cname" value="<?php echo $fet['cname']  ?>" required>
                                        </div>
                                        <div class="input-box">
                                            <span class="text">Service Type</span>
                                            <select id="trucktype" name="trucktype">
                                                <option value="<?php echo $fet['service']  ?>"><?php echo $fet['service']  ?></option>
                                        ...
                                        <div class="input-box">
                                            <span class="text">Email</span>
                                            <input type="email" name="email" value="<?php echo $fet['email']  ?>" required>
                                        </div>
                                        <div class="input-box">
                                            <span class="text">Phone Number</span>
                                            <input type="tel" name="phonenumber" value="<?php echo $fet['phonenumber']  ?>" maxlength="10" required>
                                        </div>
                                        <div class="input-box">
                                            <span class="text">From State</span>
                                            <select id="states" name="fstate">
                                                    <option value="<?php echo $fet['state']  ?>"><?php echo $fet['state']  ?></option>
                                            ...
                                            <span class="text">From District</span>
                                            <select id="districts" name="fdistrict">
                                                <option value="<?php echo $fet['district']  ?>"><?php echo $fet['district']  ?></option>
                                        ...
                                        <div class="input-box">
                                            <span class="text">To State</span>
                                            <select id="states1" name="tstate">
                                                    <option value="<?php echo $fet['tostate']  ?>"><?php echo $fet['tostate']  ?></option>
                                                    <option value="">Select a state</option>
                                                    <option value="Tamil Nadu">Tamil Nadu</option>
                                                    <option value="Andhra Pradesh">Andhra Pradesh</option>
                                                    <option value="Arunachal Pradesh">Arunachal Pradesh</option>
                                            ...
                                            <span class="text">To District</span>
                                            <select id="districts1" name="tdistrict">
                                                <option value="<?php echo $fet['todistrict']  ?>"><?php echo $fet['todistrict']  ?></option>
                                                <option value="">Select a District</option>
                                            </select>
                                        </div>
                                        <div class="input-box">
                                            <span class="text">Company Address</span>
                                            <input type="text" name="caddress" value="<?php echo $fet['caddress']  ?>" required>
                                        </div>
                                        <div class="input-box">
                                            <span class="text">Nearby Landmark</span>
                                            <input type="text" name="landmark" value="<?php echo $fet['landmark']  ?>" required>
                                        </div>
                                    </div>
                                    <div class="btn">
...
"West Bengal": ["Alipurduar", "Bankura", "Birbhum", "Cooch Behar", "Dakshin Dinajpur (South Dinajpur)", "Darjeeling", "Hooghly", "Howrah", "Jalpaiguri", "Jhargram", "Kalimpong", "Kolkata", "Malda", "Murshidabad", "Nadia", "North 24 Parganas", "Paschim Medinipur (West Medinipur)", "Paschim (West) Burdwan (Bardhaman)", "Purba Burdwan (Bardhaman)", "Purba Medinipur (East Medinipur)", "Purulia", "South 24 Parganas", "Uttar Dinajpur (North Dinajpur)"]
    ...
    const stateSelect1 = document.getElementById("states1");
    const districtSelect1 = document.getElementById("districts1");
    
    stateSelect1.addEventListener("change", function() {
      districtSelect1.innerHTML = "";
      districtSelect1.innerHTML = "<option value=''>Select a District</option>";
      if (this.value === "") return;
      const districts1 = states1[this.value];
      districts1.forEach(function(district1) {
        const option = document.createElement("option");
