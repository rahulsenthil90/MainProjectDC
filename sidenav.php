            ...
            <li class="list">
                ...
                <li class="list">
                    ...
                    <a href="truck.php">
                        ...
                        <span class="title">Rent a Truck</span>
                    </a>
                </li>
                <li class="list">
                    <b></b>
                    ...
                    <a href="cargo.php">
                        ...
                        <span class="title">Cargo Services</span>
                    </a>
                </li>
                <li class="list">
                    <b></b>
                    ...
                    <a href="packers.php">
                        ...
                        <span class="title">Packers & Movers</span>
                    </a>
                </li>
                <li class="list">
                    <b></b>
                    ...
                    <a href="recovery.php">
                        ...
                        <span class="title">Recovery Vechile</span>
                    </a>
                </li>
                <li class="list">
                    <b></b>
                    ...
                    <a href="water.php">
                        ...
                        <span class="title">Water Truck Services</span>
                    </a>
                </li>
                <li class="list">
                    <b></b>
                    <b></b>
                    <a href="usernotify.php">
        ...
        <div class="toggle">
            ...
            <script>
              ...
              /*  let menuToggle=document.querySelectorAll('.toggle');
                ...
                function signout() {
                    window.history.pushState({}, '', 'log.php');
