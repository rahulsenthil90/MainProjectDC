...
if(isset($_POST['findwater'])){
    $fstate = $_POST['fstate'];
    $fdis = $_POST['fdistrict'];


    $ser = "SELECT * FROM shipper WHERE state='$fstate' and service='Water Truck Service' and district='$fdis' ";
    ...
    <table>
            ...
            <tbody>
                ...
                if(mysqli_num_rows($qr) > 0){
                    ...
                    foreach($qr as $row){
                        echo"
                            <tr>
                                ...
                                <td>".$row['caddress']."</td>
                                <td>".$row['landmark']."</td>
                                <td><a style='text-decoration:none; color:black;' href='waterfound.php?id=$row[id]'><ion-icon name='checkbox'></ion-icon></a></td>
                            </tr>";
                            $i++;
                    }
                    ...
                    ?>
                    <tr>
                        <td colspan="7">No Office Available</td>
                    </tr>
